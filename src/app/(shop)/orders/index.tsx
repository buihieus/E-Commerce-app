import { View, Text, StyleSheet, FlatList, Pressable, ListRenderItem, ActivityIndicator } from "react-native";
...
const Orders = () => {
    ...
    if(!orders.length) return <Text style={{fontSize:16,color:'#555',textAlign:'center',padding:10,}}>No orders created yet</Text>;
    return (
...
// cái key dong duoi de fix loi dong 15
