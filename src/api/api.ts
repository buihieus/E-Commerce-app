    ...
    return useQuery({
        ...
        queryFn: async () => {
            ...
            if(categoryError || !category){
                throw new Error('An error occured while fetching category: '+categoryError?.message);
            }
            ...
            if(productsError){
                throw new Error('An error occured while fetching products: '+productsError?.message);
            }
